...
This example starts pibo with the authenticated local web channel.
...
- unauthenticated pibo API requests return `401`
...
- the web channel resolves a persistent binding with `channel: web`
