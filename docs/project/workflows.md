...
Planned follow-up documentation should cover minimal workflow definitions, interface adapter examples, XState projection details, and registry/plugin registration patterns.
