...
- `gfm-task-markdown`: GFM task-list assistant deltas with simple inline links, including strong, emphasis, or inline-code labels, that can exercise narrowly guarded task-list fast rendering while keeping small per-delta visible jumps.
